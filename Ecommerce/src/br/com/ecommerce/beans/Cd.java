...
public class Cd extends Produto implements PadraoProduto{
	...
	public void setAllCd(String descricao, float valorVenda, float valorCompra, int id, int qtde, String artista, int totalFaixas,
			boolean lancamento) {
	...
	public float retornarImposto() {
		return getValorVenda() * (float)0.070;
	}
