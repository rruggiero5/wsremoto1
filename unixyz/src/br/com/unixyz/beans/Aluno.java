...
/*
 * Design Pattern => coleção de voas práticas para Orientação a Objeto
 * DTO (Data Transfer Object) => ensina a melhor forma de criar uma classe modelo
 * 1º TODOS os atributos devem ser privados
 * 2º CAA atributo deve possuir um Getter (output) e um Setter (input)
 * 3º TODA classe modelo, deve posuir no mínimo um construtor vazio e um construtor para todos os atributos
